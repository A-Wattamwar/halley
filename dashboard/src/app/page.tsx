/**
 * Halley Dashboard — spans table.
 *
 * Server Component: queries ClickHouse directly on the server, renders
 * a static HTML table. No "use client", no client-side JavaScript needed.
 *
 ...
 * hits ClickHouse fresh. This is a dev tool; stale cached HTML is wrong.
 */
import { getClickHouseClient } from "@/lib/clickhouse";

// Opt out of static generation — query ClickHouse on every request.
...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-gray-100 p-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">Halley</h1>
